...
//            echo base_url();exit;
        ...
        $client->setClientId('529982527228-sn2a7fr47aata50ag580rgmbtjrenjvc.apps.googleusercontent.com'); // paste the client id which you get from google API Console
        $client->setClientSecret('_5nS02BrQwCCAygF-kFdZ7Nb'); // set the client secret
        ...
        $client->setDeveloperKey('AIzaSyBxm1e_QdK6bR2D2o6l2Xu5H2nZJ4sge00'); // Developer key
